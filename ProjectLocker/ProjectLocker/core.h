...
private:
    ...
    // ESP Color
    ImColor color_Normal = { 1.f, 0.f, 0.f, 1.f };
    ImColor color_Visible = { 0.f, 1.f, 0.f, 1.f };
    ImColor color_Team = { 0.f, 1.f, 1.f, 1.f };
    ImColor color_bone = { 1.f, 1.f, 1.f, 1.f };
...
public:
    ...
    void DrawLine(ImVec2 b, ImVec2 f, ImColor color, float w)
    {
    ...
    void SimpleBox(ImColor color, float x, float y, float w, float h)
    {
    ...
    void DrawBox(int x, int y, int w, int h, ImColor color, ImColor BorderColor)
    {
        SimpleBox(color, x, y, w, h);

        /*
        // Box Border

        DrawLine(ImVec2(x - 1, y - 1), ImVec2(x + w + 1, y - 1), BorderColor, 1.0f);
        DrawLine(ImVec2(x + 1, y + 1), ImVec2(x + w - 1, y + 1), BorderColor, 1.0f);

        DrawLine(ImVec2(x - 1, y - 1), ImVec2(x - 1, y + h + 1), BorderColor, 1.0f);
        DrawLine(ImVec2(x + 1, y + 2), ImVec2(x + 1, y + h - 1), BorderColor, 1.0f);

        DrawLine(ImVec2(x + w - 1, y + 1), ImVec2(x + w - 1, y + h - 1), BorderColor, 1.0f);
        DrawLine(ImVec2(x + w + 1, y - 1), ImVec2(x + w + 1, y + h + 2), BorderColor, 1.0f);

        DrawLine(ImVec2(x + 1, y + h - 1), ImVec2(x + w, y + h - 1), BorderColor, 1.0f);
        DrawLine(ImVec2(x - 1, y + h + 1), ImVec2(x + w + 1, y + h + 1), BorderColor, 1.0f);
        */
    }
    ...
    void HealthBar(float x, float y, float w, float h, int value, int v_max, bool Background)
    {
        ...
        RectFilled(x, y, x + w, y + ((h / float(v_max)) * (float)(value <= 0.f ? 0 : value)), barColor, 0.0f, 0);
    }
