...
bool Overlay::CreateOverlay()
{
    ...
    RegisterClassExA(&wc);
    Hwnd = CreateWindowExA(WS_EX_LAYERED | WS_EX_TRANSPARENT | WS_EX_TOOLWINDOW | WS_EX_TOPMOST, wc.lpszClassName, wc.lpszMenuName, WS_POPUP | WS_VISIBLE, cfg.GamePoint.x, cfg.GamePoint.y, cfg.GameRect.right, cfg.GameRect.bottom, NULL, NULL, wc.hInstance, NULL);
...
void Overlay::OverlayManager()
{
    while (cfg.Run)
    {
        ...
        static LONG MenuStyle = WS_EX_LAYERED | WS_EX_TOOLWINDOW | WS_EX_TOPMOST;
        static LONG ESPStyle = WS_EX_TRANSPARENT | WS_EX_LAYERED | WS_EX_TOOLWINDOW | WS_EX_TOPMOST;
